...
OFI openFiles[MAX_OPEN_FILES];	//global_array
...
/*
 * Η HP_SeekEntry για χρησιμοποιείται την εύρεση εγγραφής με τιμή κλειδιού id στο αρχείο της θέσης indexDesc.
 * Επιστρέφει 1 αν βρεθεί τέτοια εγγραφή και 0 αν δε βρεθεί.
 * Επιστρέφει μέσω των δεικτών το μπλοκ και τη θέση που βρίσκεται η εν λόγω εγγραφή, εφ'όσον αυτή έχει βρεθεί.
 * Αν δωθεί και δείκτης τύπου Record, επιστρέφει σε αυτόν αυτούσια την εγγραφή.
 */
int HT_SeekEntry(
	int indexDesc,	/* θέση στον πίνακα με τα ανοιχτά αρχεία */
	int id,			/* τιμή του πεδίου-κλειδιού προς αναζήτηση */
	int *idBlock,	/* το μπλοκ που βρέθηκε η εγγραφή */
	int *idPosition,/* θέση της ευρεθείσας εγγραφής στο block */
	Record *rec		/* δείκτης σε εγγραφή */
	);
